package com.tomfin46.myworldiscomics.Helpers;
...
public class ExtraTags {
    ...
    public final static String EXTRA_RES_TYPE = "com.tomfin46.myworldiscomics.RESTYPE";
    public final static String EXTRA_RES = "com.tomfin46.myworldiscomics.RES";
